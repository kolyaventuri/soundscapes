...
**Status:** pre-v0.1. Core generation/playback is implemented, and measured laptop and locked-iPhone endurance are accepted. The remaining release checks concern simple-mode event listening and rain exclusion fidelity; see the [current checklist](PLAN.md#remaining-v01-checks). Advanced layering remains an optional prototype. [SPEC.md](SPEC.md) defines the product, and [ACCEPTANCE.md](ACCEPTANCE.md) records verified behavior and limitations.
