...
export const sceneSchema = z.object({
	...
	description: z.string().max(1000).default(''), location: z.string().max(200).default(''), year: z.number().int().min(1).max(9999).nullable().default(null),
	...
	activityLevel: z.enum(['very-low', 'low', 'medium', 'high']).default('low'), sleepMode: z.literal(true),
