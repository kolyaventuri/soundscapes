...
export const eventCategorySchema = z.enum(['wind', 'leaves', 'water', 'insects', 'birds', 'objects', 'machinery', 'distant-footsteps', 'distant-wheels']);
export const sceneSchema = z.object({
	...
	ambiencePrompt: z.string().max(650).default(''),
	...
	allowedEventCategories: z.array(eventCategorySchema).max(9).default([]), simulatedStart: z.iso.datetime(),
});
